...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'user form page',
                'verbose_name_plural': 'user form pages',
            },
            bases=(wagtail.contrib.forms.models.FormMixin, 'wagtailcore.page', models.Model),
        ),
        migrations.AlterModelOptions(
            name='userindexpage',
            options={'verbose_name': 'user home page', 'verbose_name_plural': 'user home pages'},
        ),
        migrations.CreateModel(
            name='UserFormField',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='home.userformpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
