...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ntags', '0007_alter_nfctag_content_type'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='nfctag',
            name='nfc_tag_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ntags', to='ntags.nfctagtype'),
        ),
    ]
